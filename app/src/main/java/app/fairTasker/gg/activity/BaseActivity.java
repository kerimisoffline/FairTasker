...
package app.fairTasker.gg.activity;
...
import app.fairTasker.gg.FairTaskerApplication;
import app.fairTasker.gg.task.TaskRunner;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public int uiMode;
    public FairTaskerApplication application;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        application = (FairTaskerApplication) this.getApplication();
